...
//e as dimensões da imagem  a ser gravada
    ...
    private static final int TARJA_ALTURA = 60;
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Digite o Código do Equipamento (10 caracteres): ");
...
/////////////////////////////////////////////////////////////////////
    ...
    // Verifica se o arquivo é uma imagem (segue extensoes de imagens parmitidas no programa)
    ...
    private static BufferedImage redimensionarImagem(BufferedImage imagemOriginal) {
        BufferedImage imagemRedimensionada = new BufferedImage(NOVA_LARGURA, NOVA_ALTURA + TARJA_ALTURA, BufferedImage.TYPE_INT_RGB);
        ...
        g.fillRect(0, NOVA_ALTURA, NOVA_LARGURA, TARJA_ALTURA);
